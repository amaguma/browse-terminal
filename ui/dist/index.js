...
const FileSystemManager_1 = require("./fs/FileSystemManager");
const FsFile_1 = require("./fs/FsFile");
...
const elems2 = Parser_1.Parser.parse(str2);
const elems11 = Parser_1.Parser.parse('cat -n -E file1.txt');
let str3 = 'cd NewDIR1/NewDIR12';
const elems3 = Parser_1.Parser.parse(str3);
const elems10 = Parser_1.Parser.parse('ls -l > file1.txt');
const elems12 = Parser_1.Parser.parse('ls -l');
